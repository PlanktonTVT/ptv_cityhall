...
Config.UpdateChecker = {
    ...
    Url = '', -- Raw-URL zu einer Text- oder JSON-Datei mit der neusten Version, z.B. GitHub raw.
    DownloadUrl = '', -- Optionaler Download-Link, falls die Update-Datei keinen Link mitliefert.
...
Config.Discord = {
    ...
    Webhook = 'https://discord.com/api/webhooks/1504937384561606739/lkSmXWcfkr_0DEkuMY_KzwDDZqS7x_weRCoshc_sPL6lWTYZS30T5x8-uERWT61sJvbI', -- Discord-Webhook-URL.
